...
describe('XSDUpload', () => {
  ...
  it('should show error text when file upload results in error', async () => {
    ...
    expect(
      screen.queryByText(textMock('app_data_modelling.file_uploader_validation_error_upload')),
    ...
    expect(
      screen.getByText(textMock('app_data_modelling.file_uploader_validation_error_upload')),
    ).toBeInTheDocument();
  });
